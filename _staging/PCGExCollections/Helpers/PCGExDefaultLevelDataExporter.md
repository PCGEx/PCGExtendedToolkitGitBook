---
icon: cog
description: 'Default Level Data Exporter - Exports level actors as typed point data with optional collection generation'
---

# Default Level Data Exporter
...
📋 *Visible when Generate Collections is enabled*
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 7 documented (IncludeTags, ExcludeTags, IncludeClasses, ExcludeClasses, bGenerateCollections, bCaptureMaterialOverrides, bCapturePropertyDeltas)
Inherited Properties: Referenced to UPCGExLevelDataExporter
Inputs: N/A (exporter utility class)
Outputs: N/A (exporter utility class)
Nested Types: EPCGExActorExportType (enum, documented in overview)
-->
