---
icon: layer-group
description: 'Level Collection - Curated collection of Level (UWorld) references'
---
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 1 documented (Entries array with level-specific fields and bounds filtering)
Inherited Properties: Referenced to base UPCGExAssetCollection
Inputs: N/A (data asset)
Outputs: N/A (data asset)
Nested Types: FPCGExLevelCollectionEntry documented inline, bounds filtering properties documented
-->
