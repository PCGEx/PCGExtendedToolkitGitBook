---
icon: layer-group
description: 'PCG Data Asset Collection - Curated collection of PCG Data Asset references with optional level export'
---
...
→ See [Default Level Data Exporter](../Helpers/PCGExDefaultLevelDataExporter.md) for the built-in exporter and its settings.
...
<!-- VERIFICATION REPORT
Node-Specific Properties: 2 documented (LevelExporter instanced, Entries array with PCGDataAsset-specific fields)
Inherited Properties: Referenced to base UPCGExAssetCollection
Inputs: N/A (data asset)
Outputs: N/A (data asset)
Nested Types: FPCGExPCGDataAssetCollectionEntry documented inline, EPCGExDataAssetEntrySource (enum)
-->
