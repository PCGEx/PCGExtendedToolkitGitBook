...
description: 'Dynamic Mesh to Clusters - Creates clusters from dynamic mesh topology.'
---

# Dynamic Mesh to Clusters

Creates clusters from dynamic mesh topology.
...
Inherited Properties: Base UPCGExSettings (minimal, no shared settings page needed)
Inputs: Dynamic Mesh (custom pin)
Outputs: Vtx, Edges
Nested Types: EPCGExTriangulationType (documented inline), FPCGExGeoMeshImportDetails (shared type), FPCGExGraphBuilderDetails (shared type)
-->
