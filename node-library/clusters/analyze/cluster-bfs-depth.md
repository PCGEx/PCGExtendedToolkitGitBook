---
description: >-
  Computes breadth-first search depth and distance from seed points to all
  reachable vertices.
icon: share-nodes
---
...
📋 _Visible when Write Depth is enabled_
...
📋 _Visible when Write Distance is enabled_
...
📋 _Visible when Write Seed Index is enabled_
...
→ See Clusters Processor Settings for shared cluster processing options.
