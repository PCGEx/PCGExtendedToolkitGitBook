---
description: Creates a filter definition that tests points against volume data.
icon: circle-dashed
---
...
* **Check types explained**:
  ...
  * **Intersects**: The sphere must overlap a volume boundary, but the point center must be _outside_ — a "touching the edge" test.
...
📋 _Visible when Use Penetration Threshold is enabled_
